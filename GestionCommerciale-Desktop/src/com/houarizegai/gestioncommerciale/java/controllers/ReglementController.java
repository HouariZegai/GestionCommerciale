...
import com.houarizegai.gestioncommerciale.java.controllers.forms.reglement.DeleteReglementController;
import com.houarizegai.gestioncommerciale.java.controllers.forms.reglement.EditReglementController;
import com.houarizegai.gestioncommerciale.java.database.dao.ReglementDao;
import com.houarizegai.gestioncommerciale.java.database.models.Reglement;
...
public class ReglementController implements Initializable {
    ...
    private void onAdd() {
        try {
            VBox paneAddReglement = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/reglement/AddReglement.fxml"));
    ...
    private void onEdit() {
        ...
        try {
            VBox paneEditReglement = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/reglement/EditReglement.fxml"));
    ...
    private void onDelete() {
        ...
        // Show confirm dialog
        try {
            VBox paneDeleteReglement = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/reglement/DeleteReglement.fxml"));
