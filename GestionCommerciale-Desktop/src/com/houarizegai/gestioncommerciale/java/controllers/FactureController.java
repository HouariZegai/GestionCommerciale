...
import com.houarizegai.gestioncommerciale.java.database.DBConnection;
import com.houarizegai.gestioncommerciale.java.database.dao.*;
import com.houarizegai.gestioncommerciale.java.database.models.*;
import com.houarizegai.gestioncommerciale.java.database.models.designpatterns.builder.FactureBuilder;
import com.houarizegai.gestioncommerciale.java.database.models.designpatterns.builder.LigneFactureBuilder;
import com.houarizegai.gestioncommerciale.java.database.models.designpatterns.builder.ReglementBuilder;
import com.houarizegai.gestioncommerciale.java.database.models.designpatterns.builder.StockBuilder;
import com.houarizegai.gestioncommerciale.java.utils.UsefulMethods;
import com.houarizegai.gestioncommerciale.java.utils.regex.ProduitRegex;
...
public class FactureController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            selectClientView = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/facture/SelectClient.fxml"));
    ...
    private void onAdd() {
        ...
        try {
            selectProduitView = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/facture/SelectProduit.fxml"));
        } catch (IOException ioe) {
            ioe.printStackTrace();
        }
