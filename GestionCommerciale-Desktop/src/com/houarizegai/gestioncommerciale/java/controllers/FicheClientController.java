...
import com.houarizegai.gestioncommerciale.java.database.dao.FactureDao;
...
public class FicheClientController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            selectClientView = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/fiche_client/SelectClient.fxml"));
