package com.houarizegai.gestioncommerciale.java.controllers.forms.fiche_client;

import com.houarizegai.gestioncommerciale.java.controllers.FicheClientController;
...
public class SelectClientController implements Initializable {
    ...
    private void onSelect() {
        ...
        for (Client client : clients) {
            if (client.getNumClient() == Integer.parseInt(numClientSelected)) {
                FicheClientController.selectedClient = client;
                break;
            }
        }
    ...
    private void onClose() {
        FicheClientController.dialogSelectClient.close();
    }
}
