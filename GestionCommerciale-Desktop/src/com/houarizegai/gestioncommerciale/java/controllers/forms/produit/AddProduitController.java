package com.houarizegai.gestioncommerciale.java.controllers.forms.produit;

import com.houarizegai.gestioncommerciale.java.Launcher;
import com.houarizegai.gestioncommerciale.java.controllers.ProduitController;
...
import com.houarizegai.gestioncommerciale.java.database.models.FraisPort;
import com.houarizegai.gestioncommerciale.java.database.models.Produit;
import com.houarizegai.gestioncommerciale.java.database.models.designpatterns.builder.ProduitBuilder;
...
public class AddProduitController implements Initializable {
    ...
    private void onClear() { // Add clear screen (remove the content of all nodes in this field)
        ...
        imageProduit.setImage(new Image("/com/houarizegai/gestioncommerciale/resources/images/icons/add_product.png"));
