...
import com.houarizegai.gestioncommerciale.java.controllers.forms.fournisseur.DeleteFournisseurController;
import com.houarizegai.gestioncommerciale.java.controllers.forms.fournisseur.EditFournisseurController;
import com.houarizegai.gestioncommerciale.java.database.dao.FournisseurDao;
import com.houarizegai.gestioncommerciale.java.database.models.Fournisseur;
import com.houarizegai.gestioncommerciale.java.database.models.designpatterns.builder.FournisseurBuilder;
...
public class FournisseurController implements Initializable {
    ...
    private void onAdd() {
        try {
            VBox paneAddFournisseur = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/fournisseur/AddFournisseur.fxml"));
    ...
    private void onDelete() {
        ...
        // Show confirm dialog
        try {
            VBox paneDeleteFournisseur = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/fournisseur/DeleteFournisseur.fxml"));
    ...
    private void onEdit() {
        ...
        try {
            VBox paneEditClient = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/fournisseur/EditFournisseur.fxml"));
