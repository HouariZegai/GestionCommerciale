...
import com.houarizegai.gestioncommerciale.java.controllers.forms.produit.DeleteProduitController;
import com.houarizegai.gestioncommerciale.java.controllers.forms.produit.EditProduitController;
import com.houarizegai.gestioncommerciale.java.database.dao.ProduitDao;
...
public class ProduitController implements Initializable {
    ...
    private void onAdd() {
        try {
            VBox paneAddProduit = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/produit/AddProduit.fxml"));
    ...
    private void onEdit() {
        ...
        try {
            VBox paneEditProduit = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/produit/EditProduit.fxml"));
    ...
    private void onDelete() {
        ...
        // Show confirm dialog
        try {
            VBox paneDeleteProduit = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/produit/DeleteProduit.fxml"));
