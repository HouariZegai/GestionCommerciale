...
import com.houarizegai.gestioncommerciale.java.controllers.forms.client.DeleteClientController;
import com.houarizegai.gestioncommerciale.java.controllers.forms.client.EditClientController;
...
import com.houarizegai.gestioncommerciale.java.database.models.designpatterns.builder.ClientBuilder;
...
public class ClientController implements Initializable {
    ...
    private void onAdd() { // On Add ClientRegex
        try {
            VBox paneAddClient = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/client/AddClient.fxml"));
    ...
    private void onEdit() {
        ...
        try {
            VBox paneEditClient = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/client/EditClient.fxml"));
    ...
    private void onDelete() {
        ...
        // Show confirm dialog
        try {
            VBox paneDeleteClient = FXMLLoader.load(getClass().getResource("/com/houarizegai/gestioncommerciale/resources/views/forms/client/DeleteClient.fxml"));
